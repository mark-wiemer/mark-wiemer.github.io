...
<CustomImage src={Baby} alt="Me as a cute baby" />
...
{/* prettier-ignore */}
<CustomImage src={PizzaArmor} alt="Me showing off my pizza box armor">(She's been emojified because she's not the main character. Also, privacy)</CustomImage>
...
<CustomImage src={ForensicsTrophy} alt="Me posing with my high school forensics trophy" />
...
{/* prettier-ignore */}
<CustomImage src={Headshot2020} alt="Me, looking professional in February 2020">I like this shirt because it's full of equal signs. It covers my love of math and social justice! 🤓</CustomImage>
